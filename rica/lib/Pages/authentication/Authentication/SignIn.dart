...
import 'package:rica/Pages/authentication/Authentication/signup.dart';
 
import 'package:rica/widgets/responsive_ui.dart';

 
import '../../../widgets/custom_shape.dart';
import '../../../widgets/customappbar.dart';
import 'FirebaseError.dart';
import 'ResetPassowrd.dart';
...
class _SignInScreenState extends State<SignInScreen> {
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.email,
              color: Theme.of(context).primaryIconTheme.color, size: 20),
          hintText: "Email ID",
  ...
  Future<void> signIn(email, password) async {
    ...
    FirebaseAuth.instance
        ...
        .then((value) => Navigator.of(context).pushReplacementNamed("bottom_nav"))
        .catchError((onError) {
      setState(() {
        autherize = true;
        loading = false;

        erro_message = FirebaseError. getMessageFromErrorCode(onError.code);
